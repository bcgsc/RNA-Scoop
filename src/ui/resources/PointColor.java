...
public final class PointColor {
    public final static Color[] COLORS = {new Color(0.894f, 0.102f, 0.120f), new Color(0.216f, 0.494f, 0.722f),
                                          ...
                                          new Color(1.000f, 1.000f, 0.702f), new Color(0.745f, 0.729f, 0.855f),
                                          new Color(0.984f, 0.502f, 0.447f), new Color(0.502f, 0.694f, 0.827f),
                                          new Color(0.992f, 0.706f, 0.384f), new Color(0.702f, 0.871f, 0.412f),
                                          new Color(0.988f, 0.804f, 0.898f), new Color(0.851f, 0.851f, 0.851f)};
